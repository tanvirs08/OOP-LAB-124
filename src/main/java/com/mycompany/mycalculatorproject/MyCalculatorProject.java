...
package com.mycompany.mycalculatorproject;
...
public class MyCalculatorProject extends Frame  
{  
...
///////////////////////////  
MyCalculatorProject(String frameText)//constructor  
{  
super(frameText);  
...
{  
new MyCalculatorProject("Calculator - JavaTpoint");  
}  
}  
...
{  
MyCalculatorProject cl;  
  
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, MyCalculatorProject clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, MyCalculatorProject clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(MyCalculatorProject.getFormattedText(tempd));}  
...
cl.displayLabel.setText(MyCalculatorProject.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, MyCalculatorProject clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(MyCalculatorProject.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, MyCalculatorProject clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
